...
Superintendency of Companies -Super Intendencia de Compaas-
...
Highlights:
* Ecuadorian chart of accounts will be automatically installed, based on example provided by Super Intendencia de Compaas
...
---------
Master Data:
* Chart of Accounts, based on recomendation by Super Cas
